...
$sql = "INSERT INTO Contacts VALUES ('$name', '$email', '$website','$subject','$subject','$comments')";
...
$email_message .= "<tr><td><strong>Place:</strong> </td><td>" . strip_tags($_POST['website']) . "</td></tr>";
$email_message .= "<tr><td><strong>Phone Number :</strong> </td><td>" . strip_tags($_POST['subject']) . "</td></tr>";
$email_message .= "<tr><td><strong> Message :</strong> </td><td>" . strip_tags($_POST['comments']) . "</td></tr>";
$email_message .= "</table>";
